...
In order to most efficiently navigate this document, we recommend the following:
              ...
              If you have questions or encounter any difficulty with this PDF, you can reach us at: <a href="mailto:McKinsey_Website_Accessibility@mckinsey.com" target="_blank">McKinsey_Website_Accessibility@mckinsey.com</a>.
              </p>
           </div>
        <div aria-hidden="true">
          ...
          <div aria-hidden="false">
            <a href={prefix} target="_blank" aria-label="accessible PDF here" className="visually-hidden" data-layer-event-prefix="Navigation Link" data-layer-action="click" data-layer-text="Download accessible PDF here" onKeyDown={handleKeyDown}>Download accessible PDF here</a> 
          </div>
        </div>
      </div>
      )
...
In order to most efficiently navigate this document, we recommend the following:
     ...
     <div aria-hidden="true">
       <a href="https://digitalq.mckinsey.com/?v=5.1" target="_self" aria-hidden="true"  data-layer-event-prefix="Navigation Link" data-layer-action="click" data-layer-text="Tablet, mobile, and screen reader users click here">
           Tablet, mobile, and screen reader users click here
       </a>
       <div aria-hidden="false">
         <a href={prefix} target="_self" aria-label="Download accessible PDF here" className="visually-hidden" data-layer-event-prefix="Navigation Link" data-layer-action="click" data-layer-text="Screen reader users click here">Download accessible PDF here</a> 
       </div>
     </div>
   </div>
       )
